...
public class T5_dynamic_loading1 {
    ...
    public void dynamic_loading1_test(){
        ...
        BrowserUtils.waitForClickable(loopPracticeDynamicLoading1.submitButton, 10).click();
        assertTrue(BrowserUtils.waitForVisibility(loopPracticeDynamicLoading1.errorMessage, 10).isDisplayed(), "Actual does NOT match expected");
    }
}
